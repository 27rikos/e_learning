                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('quiz/create/' . $room->id) }}" class="btn btn-primary btn-sm"><i
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ url("quiz/{$item->id}/edit/{$room->id}") }}"
                                                            class="btn btn-info btn-sm">Edit</a>
                                                        &nbsp;
                                                        <form action="{{ url("quiz/{$item->id}/destroy/{$room->id}") }}"
