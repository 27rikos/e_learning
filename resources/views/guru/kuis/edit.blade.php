                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form action="{{ url("quiz/{$data->id}/update/{$room->id}") }}" method="POST"
